 ...
 *          ***=객체 지향 프로그램 (재사용 편리한 상태) => 유지보수 (대규모 프로그럄)
 *          재사용 : 수정, 추가, 데이터 보호  ====> 5장
 *                ---------- 오버라이딩/오버로딩
 ...
 *        4) 관련된 명령어를 모아서 관리 : 매소드
 *        5) 데이터/명령어를 동시에 관리 : 클래스
 *        6) 객체 지향 프로그램
 *        7) 프로그램이 비정상 종료를 벙자 / 오류를 처리 = 예외처리 (에러가 생겨도 종료되는 것을 방지)
 *        ============================================ 자바기본
 *        8)  자바에서 지원하는 라이브러리
 *      
 *      3. 자바의 구성
 ...
 *         => 빨간색으로 표시
 *         5) 길이는 제한이 없다 => (3-7글자 선호)
 *            변수 => 의미가 약간 부여
 *            a => id , name 등등
 *          =====================================
 *         과일 가게에는 사과가 5, 배가 10, 바나나 7, 딸기 1
 ...
 *         2byte => short // C언어와 호환
 *         4byte => int // 평상시에 사용하는 모든 정수 (default) (int가 가장 빠름)
 ...
 *                
 *       데이터 크기
 *       byte <short < int < long < float < double  (숫자 표현이 많아서 실수가 정수보다 크다)
 *             char  
 */
public class 변수 {
...
//		long a = 100000000000000000l; // int 데이터를 long데이터로 변환(long을 사용해도 에러가 뜰 때)
//		long a3 = (long)10.5;
//		
//		int a1 = 123456;
//		double b2 = 123456.78;
//		int c1 = (int)((b2-a1)*100);
//		System.out.println(c1);
		...
		long long_value = 999999999999999999l; //뒤에서 부터 인식함 (오른쪽에서 왼쪽 이동)
		//int/long의 구분은 l(L)
		char char_value = '홍';
		float float_value = 10.5f;
		//*****
		double double_vaule = 10.5;
		//*****
...
//	   var a = 100;
//	   var b = 10.5;
//	   var c = 'A'; //값은 변경 가능, 데이터 유형은 변경 불가능
//	   c = 97; //char는 int와 호환 가능
