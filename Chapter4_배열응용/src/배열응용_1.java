 ...
 *          클래스 //다른 데이터들을 모을 수 있음 (많이 사용) ==> 영화정보, 회원, 게시물
 *          -------
 *          ------
 *           10
 *          ------
 ...
 *       깊은 복사 ==> 새로운 주소 만들기
 *       int[] arr={}
 *       ***int[] arr1=arr.clone() => 같은 크기 //제일 간단
 *       
 *       -배열을 확장-
 *       => arraycoppy() 
 *       => for를 이용해서 데이터값만 복사
 ...
 *      int[] ===> 0
 *      char[] ===> '\u0000'
 *      String[] ===> null (모든 클래스의 기본 디폴트 null)
 *                                                ---- 메모리 주소가 없는 경우
