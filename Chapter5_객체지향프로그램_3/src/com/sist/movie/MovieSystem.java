	 ...
	 Movie[] movieListData(int no)
	 {
		 ...
		 try 
		 {
			  ...
			  * [{"startYearDate":"2023.04.12","
			  ...
			  "openDt":"20230412",
			  "salesAmt":1144439006,
			  "audiCnt":113149,"scrCnt":1525,"showCnt":4665,"rank":1,"rankInten":-1,"rankOldAndNew":"NEW","rownum":1},{"startYearDate":"2023.04.12","endYearDate":"2023.04.12","startDate":"2023년 04월 12일(수)","endDate":"202
			 */
			 Document doc=Jsoup.connect(url).get();
			 //System.out.println(doc.toString());
			 String msg=doc.toString();
			 msg=msg.substring(msg.indexOf("["),msg.lastIndexOf("]")+1);//마지막은 제외되기 때문에 +1
