...
/*
 *  자바 클래스의 구성 => ***객체지형 특성 (접근지정어,캡슐화,재사용,수정,추가)
 ...
 *             int a=10; //명시적인 초기화 
 *             => int a;
 *                 a=10; => 구현 (클래스영역에서는 구현을 못함) ==> 변수의 초기화 (생성자)
 *                 => 생성시점 : new를 이용해서 메모리 공간이 확보 , 소멸시점
 ...
 *                     => b.age
 *                     => b.name   
 *                  ==============> class는 한개만 설계 ==> 저장을 new를 이용해서 여러개 사용
 *                  
 *                  -a-
 *                  100   => 100 --------
 *                  ---          -------- age
 ...
 *                       	     --------
 *                               --------      
 *                 b=a; => 저장된 데이터 관리 위치가 변경이 될 수 있다(데이터 손실)
 *                 ========> 메모리 주소의 복구가 어렵다    
 *                              -b-
 *                  100   =>(x)200 -------- GC
 *                  ---          -------- age
 ...
 *                                 심청이
 *                       	     --------
 *                               --------           //대입을 하면 전에 b에 저장되어 있던 데이터가 다 사라진다
 *                        
 *     2) 정적변수(클래스변수,공유변수) => 한개의 공간만 생성 static
 *         => 공유변수 : 오라클
 ...
 *           (int[] arr) = 더 편함 
 *           회원가입
 *           (String id, String pwd, String name, String sex, int age, String post)
 *           (Member m) 
 *           
 *         메소드 유형
