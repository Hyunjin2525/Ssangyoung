 ...
 *       = 다른 데이터형 : 클래스
 *  3. 클래스 
 *     = 클래스 정의 방법 (객체지향프로그램 => 한개의 클래스로 만드는 것아 아니라 
 ...
 *                         1) A a=new A()
 *                         -----------------------------------------
 *                         2)A a=Claaa.forName("A").newInstance()
 *                         3) A a=A.newInstance
 *                         -------------------------------------- 리틀렉션 (스프링)
 *                    ---------------------------
 ...
 *            --
 *         }
 *         class B extends A  //코딩 양이 작아진다
 *         {
 *               void display(){} //필요한 것만 고쳐쓴다
 *         }
 ...
 *              //멜론/지니뮤직/Mnet
 *                ---  ----  ----
 *            = 유지보수용 (SM) => Jquery(Ajax) => Vue,React  //데이터 전송이 빨라짐(5G)에 맞춰서 전환됨
 *            = 단일 상속만 가능하다
 *              class A
 *              class B extends A
 *              class C extends B
 *            = 상속 내리는 클래스  : 부모클래스, 슈퍼클래스, 베이스 클래스, 상위클래스
 ...
 *               aaa.a
 *               aaa.b
 *               aaa.c ----(X) // A가 B를 상속한 것이 아니기 때문에 사용할 수 없다
 *               aaa.display() ==>2
 *               
 */ 
/*
