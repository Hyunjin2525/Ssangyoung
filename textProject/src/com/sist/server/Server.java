...
///*
// * 1. 전화 / 우편
// * 			--- 손실 가능성 있음(속도가 빠르다) => UDP
// * 	  --- 신뢰성이 뛰어남(속도가 느리다) => TCP
// * 		TCP + UDP 장점
...
// *		   -------------------------------쓰레드
// *			쓰레드는 한개 프로그램안에서 여러개의 프로그램이 동시에 작동하게 만든다
// *				  --------- 프로세스
// *			쓰레드는 시분할 => CPU를 나눠서 작업을 하기 때문에 속도가 향상
...
//	/*
//	 * Vector(네트워크) => ArrayList(데이터베이스 읽기)
//	 * 동기화		 		비동기화
//	 * 
//	 * add, get, size
//	 */
...
//	
//	//서버 가동 => 한 컴퓨터 안에서 서버를 두개 실행 할 수 없다
//	public Server() {
//		try {
